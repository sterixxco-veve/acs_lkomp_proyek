...
export const LoginScreen = ({ onLogin }) => { // Hapus goRegister & onOpenTv
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-slate-200">
            ...
            <div className="mt-6 pt-6 border-t border-slate-100 flex flex-col items-center gap-3">
              {/* TOMBOL TV DASHBOARD MENGGUNAKAN NAVIGATE */}
              <button
                type="button"
                onClick={() => navigate('/tv-dashboard-public')}
                className="w-full bg-slate-800 hover:bg-slate-900 text-white font-bold py-3 rounded-lg transition-all shadow-md active:scale-95 duration-200 flex items-center justify-center gap-2"
              >
                📺 Buka Mode Layar TV (Tanpa Login)
              </button>

              {/* TOMBOL REGISTER MENGGUNAKAN NAVIGATE */}
              <button
                type="button"
          ...
          {/* <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-xs text-blue-600 font-semibold mb-2">Demo Credentials:</p>
            <ul className="text-xs text-blue-600 space-y-1">
              <li>👤 Username: <code className="bg-blue-100 px-2 py-0.5 rounded">admin_asisten</code></li>
              <li>🔑 Password: <code className="bg-blue-100 px-2 py-0.5 rounded">anything</code></li>
              <li>👤 Username: <code className="bg-blue-100 px-2 py-0.5 rounded">kiosk_l2</code></li>
            </ul>
          </div> */}
        </div>
      </div>
